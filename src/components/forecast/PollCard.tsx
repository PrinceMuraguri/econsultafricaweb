...
const TradingWaitlistModal = lazy(() => import("./TradingWaitlistModal"));
const StakeModal = lazy(() => import("./StakeModal"));
const ExitPositionModal = lazy(() => import("./ExitPositionModal"));
const ListSharesModal = lazy(() => import("./ListSharesModal"));
