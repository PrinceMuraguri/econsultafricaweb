            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-center">
              ...
              <div className="md:col-span-3">
                ...
                <div className="text-muted-foreground leading-relaxed space-y-4">
                  <p>Prince Muraguri is the Founder and Chief Economist of Econsult Africa. His career spans research, policy, and data analysis at leading institutions including CEGA (UC Berkeley), J-PAL Africa, and the Pharo Foundation, where he contributed to large-scale research programs, monitoring systems, and policy-relevant analysis across the continent.</p>
                  <p>He specializes in translating complex macroeconomic trends into clear, decision-focused intelligence for leaders navigating dynamic and uncertain environments. His approach combines rigorous analytical foundations with practical interpretation, helping organizations move from data to strategy with confidence.</p>
                  <p>Prince holds a Master's degree in Economics and Finance from the Universidad de Navarra in Spain; a MicroMasters in Data, Economics, and Development Policy from the Massachusetts Institute of Technology (MIT); and a Bachelor's degree in Financial Economics from Strathmore University in Nairobi.</p>
                </div>
              </div>
            </div>
          </motion.div>
