                ...
                <div className="bg-primary rounded-lg p-8 text-primary-foreground card-shadow-lg" style={{ transform: "perspective(800px) rotateY(-8deg)" }}>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-mono font-semibold">4.3%</span>
                    </div>
                    <div className="flex justify-between text-sm">
        ...
        <div className="container-page">
          <div className="max-w-3xl">
            ...
            <motion.p
              ...
              className="text-lg text-muted-foreground leading-relaxed max-w-2xl">Most economic reports are built for general audiences. They aggregate, they generalize, and they arrive too late. Decision-makers in the Kenyan market need precision — specific signals calibrated to their organizations, timelines, and strategic questions.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.h2
                initial="hidden" whileInView="visible" viewport={{ once: true }}
                variants={fadeUp} custom={1}
                className="text-3xl md:text-4xl font-bold text-foreground mb-6">Intelligence calibrated for your organization.
