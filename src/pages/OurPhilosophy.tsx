  ...
  return (
    <Layout>
            ...
            <div className="lg:col-span-3">
              ...
              <motion.div
                ...
                <span className="flex items-center gap-2 text-xs text-muted-foreground">
                  <Check className="w-3.5 h-3.5 text-primary" /> Collective intelligence from the ground
                </span>
                <span className="flex items-center gap-2 text-xs text-muted-foreground">
              ...
              <motion.div
                ...
                <Button variant="hero" size="lg" className="hover-sink" asChild>
                  <Link to="/">Explore the Forecast Arena <ArrowRight className="ml-1" /></Link>
                </Button>
              ...
              <motion.p
                ...
                Real-time economic sentiment. Collective intelligence from the ground.
              </motion.p>
            </div>
            <motion.div
      ...
      <section className="section-padding bg-muted/50">
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            { icon: Zap, title: "Sentiment & Signals", description: "The 'so what' layer. We surface collective expectations and translate economic signals into practical insight your team can act on." }].
            map((item, i) =>
      ...
      <section className="section-padding bg-muted/50">
        <div className="container-page">
          <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}
          className="font-mono text-xs text-gold uppercase tracking-widest mb-4">Intelligence Products</motion.p>
          <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
        ...
        <div className="container-page relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <motion.p variants={fadeUp} custom={0} className="font-mono text-xs text-accent uppercase tracking-widest mb-4">Forecast Arena</motion.p>
              ...
              <motion.p variants={fadeUp} custom={2} className="text-background/60 leading-relaxed mb-6">
                Share your economic expectations and see what others are signaling. Real-time sentiment on the questions that matter most across African economies.
              </motion.p>
              <motion.div variants={fadeUp} custom={3} className="flex flex-wrap gap-3 mb-8">
                {[
                  { icon: BarChart3, text: "Real-time sentiment" },
                  { icon: TrendingUp, text: "Collective expectations" },
                  { icon: Globe, text: "Africa-focused signals" },
                ].map(item => (
              ...
              <motion.div variants={fadeUp} custom={4}>
                <Button variant="gold" size="lg" className="hover-sink" asChild>
                  <Link to="/">Enter the Arena <ArrowRight className="ml-1" /></Link>
                </Button>
              </motion.div>
            </motion.div>
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
              ...
              <p className="text-center text-xs text-background/30 font-mono">Live sentiment data →</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary">
        <div className="container-page text-center">
          <motion.h2
            ...
            Better Decisions Start with Better Economic Signals
          </motion.h2>
          <motion.p
